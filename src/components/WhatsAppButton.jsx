...
const WHATSAPP_NUMBER = '7994538496'; // ✅ Replace with your number

export default function WhatsAppButton() {
  const handleClick = () => {
    const text = encodeURIComponent("Hello G4 Expeditions! I'd like to enquire about your tour packages. 🌿");
